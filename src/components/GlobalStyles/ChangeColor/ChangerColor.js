...
const ChangerColor = ({ children }) => {
    ...
    if ([0, 1, 2, 8, 9, 10, 11, 12, 13, 14, 15, 16].includes(kq)) {
        ...
        if (kq === 0) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#745f88')
        ...
        if (kq === 1) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#4e4e4e')
        ...
        if (kq === 2) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#5d6780')
            document.documentElement.style.setProperty('--text-item-hover', '#fff');
        ...
        if (kq === 8) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#86837e')
        ...
        if (kq === 9) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#676767')
            document.documentElement.style.setProperty('--purple-primary', '#9b4de0');
            document.documentElement.style.setProperty('--link-text-hover', '#c273ed');
            document.documentElement.style.setProperty('--main-box-shadow', '#4242421a');
        ...
        if (kq === 10) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#66626a')
            document.documentElement.style.setProperty('--purple-primary', '#9b4de0');
            document.documentElement.style.setProperty('--link-text-hover', '#c273ed');
            document.documentElement.style.setProperty('--main-box-shadow', '#4242421a');
        ...
        if (kq === 11) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#646b7c')
        ...
        if (kq === 12) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#677488')
        ...
        if (kq === 13) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#687873')
        ...
        if (kq === 14) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#746b6a')
        ...
        if (kq === 15) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#86697e')
        ...
        if (kq === 16) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#7c6466')
        ...
        if (kq === 3) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#dfd1cc');
        ...
        if (kq === 4) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#94c2c9');
        ...
        if (kq === 5) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#deb9b8');
        ...
        if (kq === 6) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#b5b2be');
        ...
        if (kq === 7) {
            ...
            document.documentElement.style.setProperty('--duration-bg', '#e8e8e8');
